...
/***/ function(module, exports, __webpack_require__) {
	...
	var getAjax = __webpack_require__(11);

	getAjax.post('/api/skill',{},function(response){
		console.log(response);
		var html="";
		for(var i=0;i<response.length;i++){
			html += '<p class="ani" swiper-animate-effect="fadeInLeft" swiper-animate-duration="1s" swiper-animate-delay="'+i+'s">'+response[i].name+'</p>';
		}
		getAjax('#swiper-three').append(html);
	})
